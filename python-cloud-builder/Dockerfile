...
FROM gcr.io/cloud-builders/gcloud as gcloud-image
FROM python:3.7

COPY --from=gcloud-image /builder/google-cloud-sdk/ /builder/google-cloud-sdk/
# Add libmagic-dev to be able to use python-magic library
