...
def test_get_schedule(requests, snapshot):
    ...
    data = '{"idCuadro": "5", "fecha": "16/09/2021", "p": "eNEe29kXfZDAz5z94mPqWy9Q9mCzyGFZyiJh+wMWWunglvloaKL4JA=="}'  # pylint: disable=line-too-long
...
def test_get_availability(requests, snapshot):
    ...
    url = "https://www.clubconecta.cl/booking/srvc.aspx/ObtenerInformacionHuecoLibre"
    with app.test_client() as test_app:
...
def test_get_fixed_times(requests, snapshot):
    ...
    url = "https://www.clubconecta.cl/booking/srvc.aspx/ObtenerInformacionHorarioPrefijadoLibre"
    with app.test_client() as test_app:
