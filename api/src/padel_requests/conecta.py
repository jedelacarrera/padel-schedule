...
class ConectaClient(BaseClient):
    ...
    HEADERS = {
        ...
        # 'Cookie': 'ASP.NET_SessionId=x5s4gcjdqfbyg3450m2ht055; _fbp=fb.1.1672196038024.1226051803; _ga=GA1.2.1094118402.1672196039; _gid=GA1.2.235286405.1672196039; _gat_gtag_UA_225409570_1=1; i18next=es-CL',
